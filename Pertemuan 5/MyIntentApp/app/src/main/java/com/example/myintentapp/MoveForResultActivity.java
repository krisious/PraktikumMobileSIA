    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_choose) {
            if (rgNumber.getCheckedRadioButtonId() != 0) {
                int value = 0;
                int checkedRadioButtonId = rgNumber.getCheckedRadioButtonId();
                if (checkedRadioButtonId == R.id.rb_50) {
                    value = 50;
                } else if (checkedRadioButtonId == R.id.rb_100) {
                    value = 100;
                } else if (checkedRadioButtonId == R.id.rb_150) {
                    value = 150;
                } else if (checkedRadioButtonId == R.id.rb_200) {
                    value = 200;
                }
